...
const CategoryDetails = () => {
    ...
    const { toyName, toyUrl, sellerName, sellerEmail, subCategory, price, rating, quantity, details } = data
    return (
        <div className='py-10 w-[80%] mx-auto'>
            <h1 className='text-center text-4xl font-semibold py-8'>Category Details</h1>
